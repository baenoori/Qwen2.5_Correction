"""
LoRA Fine-tuned Qwen2.5-0.5B Evaluation (Hard Data - TWO errors)
Without No Error option
"""
...
def main():
    ...
    output_path = project_root / 'data' / 'response_data' / 'lora' / 'lora_hard_wo_noerror.json'
